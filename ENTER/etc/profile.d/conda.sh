export CONDA_EXE='/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/bin/conda'
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/bin/python'
