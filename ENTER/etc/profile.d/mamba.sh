echo "WARNING: /Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/etc/profile.d/mamba.sh (the file emitting this warning) is deprecated."
...
if [ -z "" ]; then
    ...
    echo "WARNING: "
    echo "WARNING: For now, we are setting 'MAMBA_ROOT_PREFIX' to '/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER'."
    echo "WARNING: "
    ...
    echo "WARNING: "
    echo "WARNING: This message originates from /Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/etc/profile.d/mamba.sh"
    export MAMBA_ROOT_PREFIX="/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER"
fi

__mamba_setup="$("/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/bin/mamba" shell hook --shell posix 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__mamba_setup"
else
    alias mamba="/Users/wangtiles/Applcns_of_ML_remote_sensing/ENTER/bin/mamba"  # Fallback on help from mamba activate
fi
unset __mamba_setup
